/*
 * @(#)$Id: oscope.h,v 1.5 1996/01/23 07:57:08 twitham Exp $
 *
...
#define DEF_C 2			/* -c: channel 1 green like a real scope */
#define DEF_M 3			/* -m: predefined 640x480 */
...
extern unsigned char old[MAXWID * 2];
